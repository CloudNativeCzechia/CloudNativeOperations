...
build-docker:
	docker build -t docker.io/pkotas/gotiny-app:noop ./cmd/gotiny/
	docker build -t docker.io/pkotas/gotiny-proxy:noop ./cmd/proxy/

push-docker:
	docker push docker.io/pkotas/gotiny-app:noop
	docker push docker.io/pkotas/gotiny-proxy:noop
