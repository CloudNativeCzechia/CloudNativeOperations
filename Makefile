...
build-docker:
	docker build -t docker.io/pkotas/gotiny-app:slogop ./cmd/gotiny/
	docker build -t docker.io/pkotas/gotiny-proxy:slogop ./cmd/proxy/

push-docker:
	docker push docker.io/pkotas/gotiny-app:slogop
	docker push docker.io/pkotas/gotiny-proxy:slogop
