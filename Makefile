...
build-docker:
	docker build -t docker.io/pkotas/gotiny-app:logop ./cmd/gotiny/
	docker build -t docker.io/pkotas/gotiny-proxy:logop ./cmd/proxy/

push-docker:
	docker push docker.io/pkotas/gotiny-app:logop
	docker push docker.io/pkotas/gotiny-proxy:logop
