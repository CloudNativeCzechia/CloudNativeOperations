...
build-docker:
	docker build -t docker.io/pkotas/gotiny-app:traceop ./cmd/gotiny/
	docker build -t docker.io/pkotas/gotiny-proxy:traceop ./cmd/proxy/

push-docker:
	docker push docker.io/pkotas/gotiny-app:traceop
	docker push docker.io/pkotas/gotiny-proxy:traceop
